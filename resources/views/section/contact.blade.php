    ...
    <div class="relative bg-slate-900/60 backdrop-blur-xl rounded-[2.5rem] border border-white/10 p-8 md:p-12 shadow-2xl overflow-hidden z-20">
        ...
        <div class="relative z-10 flex flex-col items-center">
            ...
            <div class="grid md:grid-cols-2 gap-6 w-full max-w-2xl">
                ...
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=farrelazam64@gmail.com" class="group relative flex items-center p-5 bg-slate-800/50 hover:bg-slate-800 rounded-3xl border border-white/5 hover:border-emerald-400/50 hover:shadow-[0_0_20px_rgba(52,211,153,0.15)]">
                ...
                <a href="https://wa.me/6281351408541" target="_blank" class="group relative flex items-center p-5 bg-slate-800/50 hover:bg-slate-800 rounded-3xl border border-white/5 hover:border-emerald-400/50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(52,211,153,0.15)]">
