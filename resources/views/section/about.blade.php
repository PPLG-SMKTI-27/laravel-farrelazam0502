...
<section id="tentang-saya" class="relative py-24 px-5 md:px-8 overflow-hidden transition-colors duration-700 bg-transparent dark:bg-transparent">
            ...
            <div class="flex-1 flex flex-col gap-6">
                ...
                <div class="p-10 rounded-[2.5rem] bg-[#fbfaf5] dark:bg-slate-950/40 backdrop-blur-xl border border-[#4b3621]/10 dark:border-white/10 shadow-2xl relative overflow-hidden group min-h-[300px] flex flex-col justify-between">
                    <div>
                        <div class="flex items-center gap-3 mb-6">
                            <h3 class="text-4xl font-black text-[#4b3621] dark:text-white font-dancing tracking-wide">{{ __('My Kisah') }}</h3>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="p-5 rounded-2xl bg-[#eeeae0] dark:bg-white/5 border border-[#4b3621]/5 dark:border-white/5 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-[10px] uppercase tracking-[0.2em] font-bold text-[#4b3621]/40 dark:text-slate-500 mb-1 leading-none">{{ __('Tahun Pengalaman') }}</p>
                    ...
                    <div class="p-5 rounded-2xl bg-[#eeeae0] dark:bg-white/5 border border-[#4b3621]/5 dark:border-white/5 flex items-center gap-4">
                        ...
                        <div>
                            <p class="text-[10px] uppercase tracking-[0.2em] font-bold text-[#4b3621]/40 dark:text-slate-500 mb-1 leading-none">{{ __('Projek Selesai') }}</p>
    ...
    @php
        $education = [
            ['name' => 'SMKTI AIRLANGGA', 'year' => __('2025 - Sekarang'), 'desc' => 'Fokus pada pengembangan perangkat lunak dan gim (PPLG). Mempelajari Laravel, UI/UX, dan arsitektur web modern.', 'logo' => 'Screenshot 2026-03-18 020016.png'],
