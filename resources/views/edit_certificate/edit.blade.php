                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                @if($certificate->image)
                                    <img src="{{ Storage::url($certificate->image) }}" alt="Certificate Image" class="w-24 h-24 object-cover rounded-xl border border-[#4b3621]/10 dark:border-white/10 shrink-0 shadow-md">
                                @endif
